...
RUN cd /tmp && \
    curl -L -b "oraclelicense=a" -O http://download.oracle.com/otn-pub/java/jdk/$JAVA_VERSION-$JAVA_BUILD/96a7b8442fe848ef90c96a2fad6ed6d1/jdk-$JAVA_VERSION-linux-x64.tar.gz && \
    ...
    update-alternatives --install "/usr/bin/javaws" "javaws" "/usr/lib/jvm/jdk$JAVA_SECURITY_BUILD/bin/javaws" 1000 && \
